this.questions = [
    ...
    {
        "ID":9
        ,"question":"What is the height of the tallest mountain on the earth?"
        ,"Answer":"8848m"
        ,"value":["8884m", "8488m", "8848m", "8484m"]
        ,"Category":"Science and Technology"
        ,"Level":"Medium"
    },
    {
    ...
    },
    {
        ...
        ,"Answer":"Morpheus"
        ,"value":["Zeus", "Adonis", "Morpheus", "Artemis"]
        ,"Category":"History and Mythology"
        ,"Level":"Medium"
    },
    {
    ...
    },
    {
        ...
        ,"Answer":"Iceland"
        ,"value":["Britain", "France", "Spain", "Iceland"]
        ,"Category":"History and Mythology"
        ,"Level":"Hard"
    },
    {
    ...
    {
        "ID":35
        ,"question":"Who or what gave birth to Pegasus, the winged horse?"
        ,"Answer":"Medusa's blood"
        ,"value":["Ares", "Medusa's blood", "Pan", "Zeus' crown"]
        ,"Category":"History and Mythology"
        ,"Level":"Hard"
    },
    {
    ...
    },
    {
        ...
        ,"Answer":"BedRock"
        ,"value":["Crystal Cove", "Burbank", "Kirrin", "BedRock"]
        ,"Category":"Literature and Media"
        ,"Level":"Easy"
    },
    {
    ...
    },
    {
        ...
        ,"Answer":"Pat Satjak"
        ,"value":["Alex Trebek", "Bob Barker", "Drew Carey", "Pat Satjak"]
        ,"Category":"Literature and Media"
        ,"Level":"Medium"
    },
    {
    ...
    {
        "ID":45
        ,"question":"One reason he is not buried in Westminster Abbey is his epitaph, which concludes, 'Curst be he that moves my bones'"
        ,"Answer":"William Shakespeare"
        ,"value":["William Shakespeare", "Rudyard Kipling", "William Blake", "Samuel Richardson"]
        ,"Category":"Literature and Media"
        ,"Level":"Medium"
    },
    {
        "ID":46
        ,"question":"He's the last character to die in 'Julius Caesar'"
        ,"Answer":"Brutus"
        ,"value":["Octavius", "Caesar", "Brutus", "Antony"]
        ,"Category":"Literature and Media"
        ,"Level":"Medium"
    },
    {
        "ID":47
        ,"question":"'The Road to Middle Earth' is a book about this man"
        ,"Answer":"J.R.R. Tolkien"
        ,"value":["JK Rowling", "J.R.R. Tolkien", "Rudyard Kipling", "Enid Blyton"]
        ,"Category":"Literature and Media"
        ,"Level":"Medium"
    },
    {
        "ID":48
        ,"question":"This Russian-born author & scientist who dies in 1992 said, 'I do not fear computers. I fear the lack of them'"
        ,"Answer":"Isaac Asimov"
        ,"value":["Isaac Asimov", "Ivan Turgenev", "Leo Tolstoy", "Anton Chekhov"]
        ,"Category":"Literature and Media"
        ,"Level":"Medium"
    },
    {
    ...
    {
        "ID":51
        ,"question":"Agatha Christie's husband did what for a living?"
        ,"Answer":"Archaeologist"
        ,"value":["Writer", "Archaeologist", "Businessman ", "Scientist"]
        ,"Category":"Literature and Media"
        ,"Level":"Hard"
    },
    {

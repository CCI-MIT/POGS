...
class CheckboxFieldEdit {
    ...
    constructor(question_number, question, withVideo, video_url, choices, answers, shouldRandomize){
        let str = "";
        ...
        str += '<span><div class="btn btn-sm btn-warning move_toggle">Minimize</div>Checkbox field: <span class="question_number">' + question_number + '</span></span><div class="content">';
